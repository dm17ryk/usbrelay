...
namespace usbrelay
{
    public class UsbRelayDeviceHelper
    {
        ...
        public static extern void FreeEnumerate(IntPtr deviceInfo);
        ...
        public static extern IntPtr OpenWithSerialNumber([MarshalAs(UnmanagedType.LPStr)] string serialNumber, int stringLength);
        ...
        public static extern IntPtr Open(ref UsbRelayDeviceInfo deviceInfo);
        ...
        public static extern void Close(IntPtr hHandle);
        ...
        public static extern int OpenOneRelayChannel(IntPtr hHandle, int index);
        ...
        public static extern int OpenAllRelayChannels(IntPtr hHandle);
        ...
        public static extern int CloseOneRelayChannel(IntPtr hHandle, int index);
        ...
        public static extern int CloseAllRelayChannels(IntPtr hHandle);
        ...
        public static extern int GetStatus(IntPtr hHandle, ref int status);
